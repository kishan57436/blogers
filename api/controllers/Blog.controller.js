...
export const updateBlog = async (req, res, next) => {
    try {
        const { blogid } = req.params
        // here we need the data in the form of the answer this way we can find the answer so easily wihtout having any problem 
        const data = JSON.parse(req.body.data)
...
export const deleteBlog = async (req, res, next) => {
    try {
        ...
        // Step 2: Delete associated comments
         const deletecomment=await Comment.deleteMany({ blogid });
