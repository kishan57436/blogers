...
const Comment = ({ props }) => {
    ...
    // console.log( "chek kar rha hu me",user?.isloggedIn);

    return (
        <div>
            <h4 className='flex items-center gap-2 text-2xl font-bold'> <FaComments className='text-red-500' /> Comment</h4>
            ...
            { user && user.isloggedIn
                ...
                :
                <Button asChild>
                    <Link to={RouteSign}>Sign In </Link>
                </Button>
